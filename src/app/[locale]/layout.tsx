...
// Restore the browser theme before first paint; exported HTML has no request cookies.
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: 'website',
    images: [{url: `${siteConfig.url}/Portadas/portada_1.jpg`, width: 1920, height: 820}],
  },
  twitter: {
    card: 'summary_large_image',
    images: [`${siteConfig.url}/Portadas/portada_1.jpg`],
  },
};
...
export default async function LocaleLayout({children, params}: Props) {
  ...
  const htmlClass = [fontSerif.variable, fontSans.variable].join(' ');
